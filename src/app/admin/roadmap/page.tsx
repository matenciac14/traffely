const ROADMAP: { fase: string; status: "done" | "in-progress" | "pending"; items: { label: string; done: boolean }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Subida de archivos creativos a S3 desde el drawer", done: false },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Índices de DB (@@index en workspaceId, campaignId, assigneeId)", done: false },
      { label: "Fix as any en auth config (role/workspaceId tipados)", done: false },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Encriptación de API keys en DB (AES-256)", done: false },
